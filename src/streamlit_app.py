...
# ========================= Streamlit UI =========================
st.set_page_config(page_title="Ali's Profile Chatbot", page_icon="💬", layout="centered")
st.title("Ali's Profile Chatbot")
...
user_input = st.chat_input("e.g. Tell me about your experience as Data Analytics and Engineering")
